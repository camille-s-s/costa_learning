function RNN = fitCostaRNNv2(RNNname, ...
...
% 1. smooth
% 2. remove outliers
% 3. mean subtract for each neuron (maybe)
% 4. soft normalize
...
try % choose targ subset and starting trial
    ...
    if trainFromPrev
        ...
        % targSubset = initMdl.RNN.mdl.params.targSubset; % ensure same unit subset used for all trials
    else
