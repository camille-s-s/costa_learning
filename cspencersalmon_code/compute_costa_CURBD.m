function [CURBD, CURBD_exc, CURBD_inh, trlAvgCURBD, trlAvgCURBD_exc, trlAvgCURBD_inh, curbdRgns, nRegionsCURBD] = compute_costa_CURBD(J_set, R_set, inds_set, curbdRgns, nTrls)
